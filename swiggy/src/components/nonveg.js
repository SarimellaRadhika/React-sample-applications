...
class Nonveg extends Component{
    ...
    handleDecrement=(i)=>{
        ...
        this.props.dispatch(decrement_count("nonveg",i));
    }
    handleIncrement=(i)=>{
        let temp=this.state.data
        temp[i].ordered_count=temp[i].ordered_count+1
        ...
        this.props.dispatch(increment_count("nonveg",i));
    }
render(){
        ...
        <div className="maindiv">
            {
                data.map((val,i)=>{
                    return <div>
                                <div className="card"><img src={require("../nonveg/"+val.path)} alt="hi" style={{height:150, width:180}}/>
...
export default connect(null)(Nonveg);