...
class Tiffin extends Component{
    constructor(props){
        super(props)
        this.state={
            data:[
    ...
    handleDecrement=(i)=>{
        ...
        this.props.dispatch(decrement_count("tiffins",i))
    }
    handleIncrement=(i)=>{
        let temp=this.state.data
        temp[i].ordered_count=temp[i].ordered_count+1
        ...
        this.props.dispatch(increment_count("tiffins",i))
    }
        ...
        <div className="maindiv">
            {
                data.map((val,i)=>{
                    return <div>
                                <div className="card"><img src={require("../tiffins/"+val.path)} alt="hi" style={{height:150, width:180}}/>
...
export default connect(null)(Tiffin);