  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance, settings) { 
      var $tabsContainer = $('<div class="scrtabs-tab-container"></div>'),
          $leftArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-left"><span  class="fa fa-caret-left fa-2x" aria-hidden="true"></span></div>'),
          $rightArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-right"><span class="fa fa-caret-right fa-2x" aria-hidden="true"></span></div>'),
